...
twc_spawnFOB = compile preprocessfilelinenumbers "Insurgency_Core\server\func\fnc_spawnFOB.sqf";
...
twc_fnc_townReset = compile preprocessfilelinenumbers "Insurgency_Core\server\func\fnc_townReset.sqf";