...
_trg setTriggerStatements ["{(side (_x)) == WEST} count thisList == 0 || (({((side (_x)) == east) && ((str (_x getvariable ['unitshome', [1,1,1]])) == (str (thisTrigger getVariable 'unitsHome')))} count thisList < 1) && ({((side (_x)) == resistance) && ((str (_x getvariable ['unitshome', [1,1,1]])) == (str (thisTrigger getVariable 'unitsHome')))} count thisList < 1))","[thistrigger, (({((side (_x)) == east) && ((str (_x getvariable ['unitshome', [1,1,1]])) == (str (thisTrigger getVariable 'unitsHome')))} count thisList) + ({((side (_x)) == resistance) && ((str (_x getvariable ['unitshome', [1,1,1]])) == (str (thisTrigger getVariable 'unitsHome')))} count thisList))] spawn {params ['_trg', '_lst'];sleep 100;[(_trg getVariable 'unitsHome'), _lst] call twc_fnc_townmarker;};[(thisTrigger getVariable 'unitsHome'), thisList] spawn twc_fnc_townDeciding; ",""];
