...
_trg2 setTriggerStatements ["twc_terp in thislist","[nearestObjects [thistrigger, ['soldiergb'], 500]] execvm 'Insurgency_Core\server\sys_terp\fnc_terp_stronghold.sqf'",""];
