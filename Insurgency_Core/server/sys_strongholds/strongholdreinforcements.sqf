...
_wp setWaypointStatements ["true", "_pos = (group this) getvariable ['twc_strongholdpos', (getpos this)];[group this, _pos, 300, 3, 0.5, 0.2] call CBA_fnc_taskDefend;['TWC_Insurgency_adjustInsurgentMorale', 1] call CBA_fnc_serverEvent;
