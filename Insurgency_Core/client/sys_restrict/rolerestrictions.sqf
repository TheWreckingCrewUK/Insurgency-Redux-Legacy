...
cutText ["", "Black", 0.001];
player forceWalk true;
while {( count(allPlayers - entities "HeadlessClient_F")) < 3} do {
cutText ["", "Black", 0.001];
    [
        "<t size='1.2'>Helicopter Pilot</t><br/><t size='0.6'>You need 3 or more people before you can be a helicopter pilot</t>", 0, 0.22, 5, 0, 0, 2
    ] spawn bis_fnc_dynamictext;
...
cutText ["", "Black", 0.001];
    [
        "<t size='1.2'>Fire Support Team</t><br/><t size='0.6'>You need 5 or more people before you can be in the Fire Support Team</t>", 0, 0.22, 5, 0, 0, 2
    ] spawn bis_fnc_dynamictext;
...
cutText ["", "Black", 0.001];
    [
        "<t size='1.2'>Armour Crew</t><br/><t size='0.6'>You need 3 or more people before you can be in the Armour Crew</t>", 0, 0.22, 5, 0, 0, 2
    ] spawn bis_fnc_dynamictext;
