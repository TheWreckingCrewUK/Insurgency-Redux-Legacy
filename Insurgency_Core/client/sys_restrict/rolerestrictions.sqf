...
cutText ["", "Black", 0.001];
    [
        "<t size='1.2'>Sniper Team</t><br/><t size='0.6'>You need 10 or more players on the server before you can be in a sniper team</t>", 0, 0.22, 5, 0, 0, 2
    ] spawn bis_fnc_dynamictext;
...
if (( count(allPlayers - entities "HeadlessClient_F")) < 12) then {

cutText ["", "Black", 0.001];
player forceWalk true;
while {( count(allPlayers - entities "HeadlessClient_F")) < 12} do {
cutText ["", "Black", 0.001];
    [
        "<t size='1.2'>Armour Crew</t><br/><t size='0.6'>You need 13 or more people before you can be in the Armour Crew</t>", 0, 0.22, 5, 0, 0, 2
    ] spawn bis_fnc_dynamictext;
