...
if (_civilianQuestioned in nonQuestionableList) then {
	...
	if (_givenNumber == 0) then {
		switch (True) do {
			case (floor TWC_civMorale <= 15):{hintSilent "I hope they kill you on your way there!"};
			case (floor TWC_civMorale <= 30):{hintSilent "I'll mark a spot. Now LEAVE!"};
			case (floor TWC_civMorale <= 45):{hintSilent "I'll mark the position on your map."};
			case (floor TWC_civMorale <= 60):{hintSilent "Let me mark the position on your map."};
			case (floor TWC_civMorale <= 75):{hintSilent "I think I know where they are. I'll mark the position on your map."};
			case (floor TWC_civMorale <= 90):{hintSilent "I'll mark your map. Be careful."};
			case (floor TWC_civMorale > 90):{hintSilent "I believe they are somewhere around here. Good luck."};
		...
		switch (True) do {
			case (floor TWC_civMorale <= 15):{hintSilent "DEATH TO THE FOREIGN INVADERS!!"};
			case (floor TWC_civMorale <= 30):{hintSilent "Even if I did happen to know something I wouldn't tell you."};
			case (floor TWC_civMorale <= 45):{hintSilent "I can't help you. Leave our villlage. Haran!"};
			case (floor TWC_civMorale <= 60):{hintSilent "I don't know anything."};
			case (floor TWC_civMorale <= 75):{hintSilent "I'm just a villager, I know nothing"};
			case (floor TWC_civMorale <= 90):{hintSilent "Sorry, but I don't know anything"};
