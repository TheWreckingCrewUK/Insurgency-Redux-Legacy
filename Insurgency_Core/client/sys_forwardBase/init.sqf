...
_action = ["SpawnForwardBase","Spawn PB Gear","",{[_player] call twc_fnc_spawnForwardBaseItems;_return},{leader _player == _player && ((count units group player >= 4) || count allPlayers < 4)}] call ace_interact_menu_fnc_createAction;
