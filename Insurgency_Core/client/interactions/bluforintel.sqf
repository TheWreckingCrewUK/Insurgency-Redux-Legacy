...
InsP_MissionStatus = ["MissionStatus","BLUFOR Intel","",{call twc_bluforintelplayerhint},{((side player) == west)}] call ace_interact_menu_fnc_createAction;
[player, 1, ["ACE_SelfActions"], InsP_MissionStatus] call ace_interact_menu_fnc_addActionToObject;

twc_bluforintelplayerhint = {
