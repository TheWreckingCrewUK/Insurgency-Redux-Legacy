...
[] spawn {
	sleep 5;
	_relpos = tank getRelPos [7, 2];
	_wall = "Land_Wired_Fence_8mD_F" createvehicle [0,0,0];
	_wall setdir (getdir tank);
	_wall setpos _relpos;
	sleep 5;
	
	deletevehicle _wall;
	_wall = "Land_HBarrier_Big_F" createvehicle [0,0,0];
	_wall setdir (getdir tank);
	_wall setpos _relpos;
};
...
[] spawn {
	...
	deletevehicle _wall;
	_wall = "Land_Rampart_F" createVehicle [0,0,0];
	_wall setdir ((getdir tank) + 90);
	_wall setpos _relpos;
};