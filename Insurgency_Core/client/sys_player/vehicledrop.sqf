...
_vehicle = createvehicle ["UK3CB_BAF_LandRover_Soft_Green_A", [0,0,0]];
_total = ceil (((_playercount * 0.5)-(count (_boxpos nearentities ["car", 200])))* 1.5) max 1;
...
_wmik = createvehicle ["UK3CB_BAF_LandRover_WMIK_GPMG_Green_A", _spawnPos];  
...
//_spawnPos = [_pos,[5,50],random 360,0, [1,50], [50,(typeof _vehicle)]] call SHK_pos; 
_spawnPos = [_pos, 5, 50, 10, 0, 1, 0, [], [_pos, _pos]] call BIS_fnc_findSafePos;
_car = createvehicle ["UK3CB_BAF_LandRover_Soft_Green_A", _spawnPos];
sleep 1;
