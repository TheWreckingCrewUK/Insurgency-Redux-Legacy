...
if((typeOf player) in ["Modern_British_Squadleader","Modern_British_2IC_COIN","Modern_British_Squadleader_Light","Modern_British_2IC_COIN_Light","Modern_UKSF_Squadleader","Modern_UKSF_2IC"])then{
	...
	if ((typeof player) in ["Modern_UKSF_Squadleader","Modern_UKSF_2IC"]) then {
		...
		["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnheavy"],_UKaction,true] call ace_interact_menu_fnc_addActionToClass;
	} else {
...
if((typeOf player) in ["Modern_USMC_Squadleader","Modern_USMC_Teamleader", "Modern_USMC_Squadleader_d","Modern_USMC_Teamleader_d"])then{
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "weaponspawn"],_UKaction3,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_charlieaction1,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["Modern_British_Sniper_coin", "Modern_British_Spotter_coin"])then{
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnheavy"],_snaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	_actionempty = ["SpawnemptyCreate","Spawn Small Empty Crate","",{execvm "Insurgency_Core\client\sys_player\boxes\supply_boxes\smallemptycrate.sqf"},_condition] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_actionempty,true] call ace_interact_menu_fnc_addActionToClass;
	...
	_UKaction5 = ["SpawnmedCreate","Hilux","",{execvm "insurgency_core\client\sys_player\vehicles\sfpickup.sqf"},{(((group player) getvariable ["twc_groupcountry", "baf"]) in ["rangersniper", "uksf"])}] call ace_interact_menu_fnc_createAction;
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "vehiclespawn"],_UKaction5,true] call ace_interact_menu_fnc_addActionToClass;
};
...
if((typeOf player) in ["1990_British_2IC","1990_British_SectionCommander","1990_British_2IC_Desert","1990_British_SectionCommander_Desert"])then{
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_90UKaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_90charlieaction2,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["1990_RM_British_2IC_Mix","1990_RM_British_SectionCommander_Mix"])then{
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnlight"],_90rmUKaction,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_90rmUKaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_90rmUKaction3,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_90rmUKaction4,true] call ace_interact_menu_fnc_addActionToClass;
	...
	["Land_InfoStand_V1_F",0,["ACE_MainActions", "ammospawn", "ammospawnsupport"],_90rmaction2,true] call ace_interact_menu_fnc_addActionToClass;
