	...
	
{
	...
	_twc_removeflag = ["clearflag","Remove Flag","",{deletevehicle _target},_condition] call ace_interact_menu_fnc_createAction;
...
if((typeOf player) in ["Modern_British_HeliPilot","Modern_British_crewchief"])then{
	...
	[_x,0,["ACE_MainActions"],_haction5,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_hfstaction3,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["Modern_British_Squadleader","Modern_British_2IC_COIN"])then{
	...
	[_x,0,["ACE_MainActions"],_UKaction,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_UKaction1,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["Modern_USMC_Squadleader","Modern_USMC_Teamleader", "Modern_USMC_Squadleader_d","Modern_USMC_Teamleader_d"])then{
	...
	[_x,0,["ACE_MainActions"],_charlieaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_charlieaction2,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["1990_British_quartermaster_Desert"])then{
	...
	[_x,0,["ACE_MainActions"],_qm90action1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_qm90action3,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_qm90action4,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["1990_British_mg_assistant_Desert"])then{
	...
	[_x,0,["ACE_MainActions"],_mgaction,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["1990_British_2IC_Desert","1990_British_SectionCommander_Desert"])then{
	...
	[_x,0,["ACE_MainActions"],_90UKaction,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90UKaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90UKaction3,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90UKaction4,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90charlieaction2,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["1990_RM_British_2IC_Mix","1990_RM_British_SectionCommander_Mix"])then{
	...
	[_x,0,["ACE_MainActions"],_90rmUKaction,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90rmUKaction1,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90rmUKaction3,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90rmUKaction4,true] call ace_interact_menu_fnc_addActionToClass;
	...
	[_x,0,["ACE_MainActions"],_90rmaction2,true] call ace_interact_menu_fnc_addActionToClass;
...
if((typeOf player) in ["2000_British_HeliPilot_Desert","2000_British_HeliPilot","2000_British_Vehicle_Commander"])then{
